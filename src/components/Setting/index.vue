    ...
    <div class="tmv-setting">
        <Popover :visible="popoverVisible" :onVisibleChange="handlePopoverVisibleChange">
            ...
            <template v-slot:popoverContent>
                <div class="tmv-setting-item" @click="handlePopoverVisibleChange(false)">
                    <label>自动连播</label>
                    <div class="tmv-switch" :class="{ 'tmv-switch-active': true }">
